...
type Documents = {
    ...
    "query FindAllFilterVideos($input: FindAllFilterVideosInput!) {\n  findAllFilterVideos(input: $input) {\n    id\n    slug\n    title\n    description\n    thumbnailUrl\n    durationSeconds\n    access\n    status\n    ownerId\n    createdAt\n    updatedAt\n  }\n}": typeof types.FindAllFilterVideosDocument,
...
const documents: Documents = {
    ...
    "query FindAllFilterVideos($input: FindAllFilterVideosInput!) {\n  findAllFilterVideos(input: $input) {\n    id\n    slug\n    title\n    description\n    thumbnailUrl\n    durationSeconds\n    access\n    status\n    ownerId\n    createdAt\n    updatedAt\n  }\n}": types.FindAllFilterVideosDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindAllFilterVideos($input: FindAllFilterVideosInput!) {\n  findAllFilterVideos(input: $input) {\n    id\n    slug\n    title\n    description\n    thumbnailUrl\n    durationSeconds\n    access\n    status\n    ownerId\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["query FindAllFilterVideos($input: FindAllFilterVideosInput!) {\n  findAllFilterVideos(input: $input) {\n    id\n    slug\n    title\n    description\n    thumbnailUrl\n    durationSeconds\n    access\n    status\n    ownerId\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
