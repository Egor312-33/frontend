...
export type Scalars = {
  ...
  /** Date scalar that handles proto Timestamp { seconds, nanos } */
...
export type FindAllFilterVideosInput = {
...
export type Query = {
  ...
  findAllFilterVideos: Array<VideoModel>;
  ...
  getUserSystemMessages: GetUserMessagesPayload;
...
export type QueryFindAllFilterVideosArgs = {
  input: FindAllFilterVideosInput;
};
...
export type GetUserSystemMessagesQuery = { __typename?: 'Query', getUserSystemMessages: { __typename?: 'GetUserMessagesPayload', chatId: string, encryptedChatKey: string, messages: Array<{ __typename?: 'SystemMessageModel', authTag: string, chatId: string, content: string, createdAt: any, id: string, initialVector: string, isDeleted: boolean, isEdited: boolean, senderId: string, updatedAt: any }> } };

export type FindAllFilterVideosQueryVariables = Exact<{
  input: FindAllFilterVideosInput;
}>;


export type FindAllFilterVideosQuery = { __typename?: 'Query', findAllFilterVideos: Array<{ __typename?: 'VideoModel', id: string, slug: string, title: string, description?: string | null, thumbnailUrl?: string | null, durationSeconds?: number | null, access: Access, status: Status, ownerId: string, createdAt: any, updatedAt: any }> };
...
export const FindAllFilterVideosDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FindAllFilterVideos"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FindAllFilterVideosInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findAllFilterVideos"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"thumbnailUrl"}},{"kind":"Field","name":{"kind":"Name","value":"durationSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"access"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"ownerId"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<FindAllFilterVideosQuery, FindAllFilterVideosQueryVariables>;
