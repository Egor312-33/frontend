...
import type { GetStreamerStatsQuery } from '@/shared/gql/cms/graphql'
import { formatDate } from '@/utils/format-date'

type StreamerStats = NonNullable<GetStreamerStatsQuery['StreamerStats']>
type CountsType = StreamerStats['counts']
type RecentEvents = StreamerStats['recentEvents']
...
export function StatsTabView({ counts, events }: StatsTabViewProps) {
	return (
