	...
	return (
		<div className='w-full'>
			<div className='border-border from-card via-background to-card relative overflow-hidden rounded-2xl border bg-linear-to-br p-6 md:p-8'>
				...
				<div className='mb-8'>
					<div className='border-border from-secondary-dark via-secondary to-secondary-dark flex [scrollbar-width:none] gap-1 overflow-x-auto rounded-t-xl border-b-2 bg-linear-to-br p-2 [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden'>
						{tabs.map(tabItem => {
